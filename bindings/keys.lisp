...
(defvar <F2> (list #\esc #\O #\Q))
(defvar <F3> (list #\esc #\O #\R))
(defvar <F4> (list #\esc #\O #\S))
(defvar <F5> (list #\esc #\[ #\1 #\5 #\~))
(defvar <F6> (list #\esc #\[ #\1 #\7 #\~))
(defvar <F7> (list #\esc #\[ #\1 #\8 #\~))
(defvar <F8> (list #\esc #\[ #\1 #\9 #\~))
(defvar <F9> (list #\esc #\[ #\2 #\0 #\~))
(defvar <F10> (list #\esc #\[ #\2 #\1 #\~))
(defvar <F12> (list #\esc #\[ #\2 #\4 #\~))

(defvar <Insert> (list #\esc #\[ #\2 #\~))
(defvar <Del> (list #\esc #\[ #\3 #\~))
(defvar <Backspace> #\backspace)

(defvar <Up> (list #\esc #\[ #\A))
(defvar <Down> (list #\esc #\[ #\B))
(defvar <Right> (list #\esc #\[ #\C))
(defvar <Left> (list #\esc #\[ #\D))
